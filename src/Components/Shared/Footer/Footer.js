...
const Footer = () => {
    ...
    return (
        <footer className={`text-center bg-gray-900 text-white ${(location === '/inventory' || location === '/blogs'  ) && 'hidden' } `}>
            ...
            >
                © 2022 Copyright:
                <a className="text-whitehite" href="https://tailwind-elements.com/">Nishad's creation</a>
            </div>
        </footer>
    );
};
