...
const OurApp = () => {
    return (
        <div class="pt-8 pb-12 md:py-3 lg:py-3 overflow-x-hidden border-2 rounded-xl lg:m-14 m-9 p-2 shadow-xl bg-slate-200 " id="key-features">
                ...
                <div class="flex flex-wrap lg:flex-nowrap">
                    ...
                    <div class="relative w-full lg:w-1/2 my-12 lg:my-0">
                        ...
                        >
                            ...
                            <img class="jump relative mx-auto rounded-xl w-1/3 z-10" src="https://i.ibb.co/mvCPyhy/our-app.png" alt="Monst" />
